...
```text
/home/spark4/ds4-vllm-local-c6e55a8
/home/spark5/ds4-vllm-local-c6e55a8
/home/spark4/ds4-vllm-local -> ds4-vllm-local-c6e55a8
/home/spark5/ds4-vllm-local -> ds4-vllm-local-c6e55a8
```
...
git checkout c6e55a80d213ba2652ab9a7d5d0aacf01cbccd34
python3.12 -m venv ~/ds4-vllm-local-c6e55a8
...
~/ds4-vllm-local-c6e55a8/bin/python -m pip install -U pip wheel setuptools
~/ds4-vllm-local-c6e55a8/bin/python -m pip install -e .
ln -sfn ~/ds4-vllm-local-c6e55a8 ~/ds4-vllm-local
```
