...
class SparkControlTests(unittest.TestCase):
    def test_registry_keeps_legacy_qwen27_but_defaults_to_bf16_pipeline(self) -> None:
        ...
        qwen_profiles = {profile.profile_id: profile for profile in registry.all_profiles() if "Qwen3.6-27B" in profile.model_id}
        self.assertIn("qwen3_6_27b_fp8_efficient_v1", qwen_profiles)
        self.assertIn(QWEN_FAST_PP, qwen_profiles)
        ...
        self.assertEqual(registry.resolve(capability="fast", chat=False, job_class="summary").profile_id, QWEN_FAST_PP)

    def test_qwen27_nvfp4_pipeline_contract_uses_spark0_entry_and_pp8(self) -> None:
        contract = json.loads((CONTRACTS / "qwen27_nvfp4_pp8_v1.json").read_text(encoding="utf-8"))
        args = contract["launch"]["args"]
        self.assertEqual(contract["launch"]["api_base_url"], "http://127.0.0.1:8103")
        ...
        self.assertEqual(args[args.index("--quantization") + 1], "modelopt")
        self.assertEqual(args[args.index("--linear-backend") + 1], "flashinfer-cutlass")
    ...
    def test_qwen_trim_plan_uses_pipeline_entry_endpoint(self) -> None:
        ...
        self.assertEqual(plan["profile_id"], QWEN_FAST_PP)
        self.assertEqual(plan["runtime_contract_id"], "qwen27_nvfp4_pp8_v1")
    ...
    def test_dsv4_trim_plan_requires_profile_and_uses_pipeline_entry(self) -> None:
        ...
        self.assertEqual(default["profile_id"], QWEN_FAST_PP)
    ...
    def test_every_spark_trims_through_single_entry_with_override_preserved(self) -> None:
        ...
        self.assertEqual(custom["profile_id"], QWEN_FAST_PP)
    ...
    def test_tool_lattice_exposes_same_high_level_api(self) -> None:
        ...
        self.assertEqual(result["result"]["endpoint"]["base_url"], "http://127.0.0.1:8103")
