...
class PipelineApiTests(unittest.TestCase):
    ...
    def test_deployment_readiness_is_strict_about_jit_kv_token(self) -> None:
        ...
        self.assertEqual(payload["resident_gpu_memory_utilization"], {"dsv4_flash_pp8": 0.08, "gemma4_26b_a4b_pp8": 0.25, "qwen27_bf16_pp8": 0.25})
        self.assertAlmostEqual(payload["resident_gpu_memory_utilization_sum"], 0.58)
