...
class KvCachePlanningTests(unittest.TestCase):
    ...
    def test_glm52_pp13_direct_plan_fills_pipeline(self) -> None:
        ...
        self.assertEqual(rank0["argv"][rank0["argv"].index("--max-num-seqs") + 1], "64")
        ...
        self.assertEqual(rank0["env"]["VLLM_DS4_SCHED_MAX_NEW_REQS_PER_STEP"], "64")
        self.assertEqual(rank12["env"]["VLLM_DS4_SCHED_MAX_NEW_REQS_PER_STEP"], "64")
