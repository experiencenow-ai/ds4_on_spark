...
class KvCachePlanningTests(unittest.TestCase):
    ...
    def test_kimi27_pp13_lmcache_plan_uses_uniform_local_directory_and_source_guard(self) -> None:
        ...
        self.assertEqual(rank0["argv"][rank0["argv"].index("--gpu-memory-utilization") + 1], "0.33")
        self.assertEqual(rank0["argv"][rank0["argv"].index("--kv-cache-memory-bytes") + 1], "7516192768")
