...
class StaticSparkTopologyTests(unittest.TestCase):
    ...
    def test_first_three_services_declare_external_cache_backends_and_safe_gpu_caps(self) -> None:
        ...
        expected = {
            ...
            "dsv4_flash_pp8": ("dsv4_hma", "simple_cpu_offload", "/home/{node}/ds4_nvme/ds4_hma_store/dsv4_flash_pp8/simple_cpu_offload", 0.08),
        }
    ...
    def test_pipeline_services_are_all_spark_and_spark0_ingress(self) -> None:
        ...
        self.assertEqual(qwen.layer_partition, (8, 8, 8, 9, 8, 8, 8, 7))
        self.assertEqual(qwen_bf16kv.layer_partition, (8, 8, 8, 9, 8, 8, 8, 7))
    ...
    def test_startup_plan_marks_ingress_and_stage_items(self) -> None:
        ...
        self.assertEqual(spark4["items"][0]["layer_start"], 33)
