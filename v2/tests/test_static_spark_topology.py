...
class StaticSparkTopologyTests(unittest.TestCase):
    def test_kimi_qwen_gemma_pp13_topology_uses_all_thirteen_sparks(self) -> None:
        ...
        self.assertEqual(kimi.kv_cache["gpu_memory_utilization"], 0.33)
    ...
    def test_kimi_qwen_readiness_counts_fixed_kv_bytes_as_headroom(self) -> None:
        ...
        self.assertEqual(payload["resident_gpu_memory_utilization"], {"kimi27_pp13": 0.33, "qwen27_bf16_pp13": 0.24})
        ...
        self.assertAlmostEqual(payload["resident_gpu_memory_utilization_sum"], 0.57)
        self.assertEqual(payload["resident_fixed_kv_cache_memory_bytes"], {"kimi27_pp13": 7516192768, "qwen27_bf16_pp13": 7516192768})
        self.assertEqual(payload["resident_fixed_kv_cache_memory_bytes_sum"], 15032385536)
        kimi = topology.pipeline_service_by_id("kimi27_pp13")
        self.assertEqual(kimi.scheduler["admission_mode"], "resident_multimodel_rolling_refill")
