# Baseline: Quantized Single-Spark Spark0 (DeepSeek V4 Flash IQ2XXS smallest trunk (chat-v2))

Date (UTC): 2026-05-13T00:30:47Z
...
| N/A   53C    P0             13W /  N/A  | Not Supported          |      0%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
- ds4_on_spark commit: `19278bc92b767fcd352c9dae258e761c13c72715`
- Upstream commit(s):
...
Fixture:
  ...
  runtime_label: v4flash-external
  notes: staged:/home/spark0/models/ds4 (pinned smallest trunk) (IQ2XXS smallest trunk (chat-v2))
```
...
```sh
ALLOW_RUN='1' MODEL_SOURCE='staged:/home/spark0/models/ds4 (pinned smallest trunk)' MODEL_QUANT='IQ2XXS smallest trunk (chat-v2)' MODEL_GGUF='/home/spark0/models/ds4/DeepSeek-V4-Flash-IQ2XXS-w2Q2K-AProjQ8-SExpQ8-OutQ8-chat-v2.gguf' LLAMA_CLI='/home/spark0/src/llama.cpp-kamnxt/build-cuda/bin/llama-cli' LLAMA_DIR='/home/spark0/src/llama.cpp-kamnxt' RUNTIME_LABEL='v4flash-external' CTX='512' N_TOKENS='32' N_GPU_LAYERS='99'
```
...
- ttft_s: `0.073576`
- prefill_tps: `22.500000`
- decode_tps: `14.000000`
- total_wall_s: `584.360759`
- output_tokens: `32`
- max_rss_kb: `85003236`
...
runtime_label=v4flash-external
model_source=staged:/home/spark0/models/ds4 (pinned smallest trunk)
model_quant=IQ2XXS smallest trunk (chat-v2)
...
ttft_first_output_s=0.073576
ttft_s=0.073576
wall_s=584.360759
total_wall_s=584.360759
max_rss_kb=85003236
prefill_tps=22.500000
generation_tps=14.000000
decode_tps=14.000000
output_tokens=32
fattn_log_lines=9890
fattn_unique_nodes=43
