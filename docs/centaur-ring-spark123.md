...
- Centaur zip facts: `ls -la` and `sha256` of `centaur_spec_impl_v73.zip` (Mac-side helper: `sh ./scripts/centaur_v73_zip_facts.sh /Users/mac/Downloads/centaur_spec_impl_v73.zip`)
