...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `b735ca178c9c60ed5f66a3c5428212a7b02a17c4` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
