...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `8cc16c99748b8c92097d6094aad694448fb8fb0e` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
