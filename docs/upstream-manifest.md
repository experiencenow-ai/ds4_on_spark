...
| MiniMax-M2.7-DFlash (HF) | `huggingface.co/z-lab/MiniMax-M2.7-DFlash` | `refs/heads/main` | `0b9e26e35d991dc03f6b4198fb9681a1ab053e70` | UNKNOWN | Paired DFlash draft checkpoint (1.04 GiB safetensors) for exact target `MiniMaxAI/MiniMax-M2.7`; model card raw access returned HTTP 401 at pinned sha; treat license as unknown until verified; do not download weights without human approval; see `docs/upstream-dflash.md`. |
