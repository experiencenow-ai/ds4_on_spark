...
| Kimi-K2.6 (HF) | `huggingface.co/moonshotai/Kimi-K2.6` | `refs/heads/main` | `2755962d07cb42aa2d988a35bcb65cd4a9c2de82` | Modified-MIT | Follow-up Kimi MoE target (554.30 GiB safetensors; not single-Spark plausible); keep as provenance reference only for paired DFlash drafts. |
