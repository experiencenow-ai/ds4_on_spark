...
| --- | --- | --- | --- | --- | --- |
| ds4 | `antirez/ds4` | `refs/heads/main` | `9deabad750f7662b7dd7a63eec2ea75f0d9e0118` | MIT | DeepSeek-V4-Flash-specific native engine (Metal-first); semantics + KV-cache design reference; do not run upstream model-download scripts. |
...
| Kimi-K2.6 (HF) | `huggingface.co/moonshotai/Kimi-K2.6` | `refs/heads/main` | `81bcaaa7947338ce2641983d98947bca0cc1a4d4` | Other | Follow-up Kimi MoE target (554.30 GiB safetensors; not single-Spark plausible); HF license tag currently reports `other`; keep as provenance reference only for paired DFlash drafts. |
...
| MiniMax-M2.7-DFlash (HF) | `huggingface.co/z-lab/MiniMax-M2.7-DFlash` | `refs/heads/main` | `6776d46e03667fc381becf652938645639e279bb` | UNKNOWN | Paired DFlash draft checkpoint (1.04 GiB safetensors) for exact target `MiniMaxAI/MiniMax-M2.7`; model card raw access returned HTTP 401 at pinned sha; treat license as unknown until verified; do not download weights without human approval; see `docs/upstream-dflash.md`. |
...
| Qwen3.5-4B (HF) | `huggingface.co/Qwen/Qwen3.5-4B` | `refs/heads/main` | `851bf6e806efd8d0a36b00ddf55e13ccb7b8cd0a` | Apache-2.0 | Smallest Qwen comparison target (8.68 GiB safetensors); do not download weights without human approval; see `docs/upstream-qwen-dflash.md`. |
...
| llama.cpp | `ggml-org/llama.cpp` | `refs/tags/b9102` | `7d442abf5c6244117fd5a1dc51a5d19f00792491` | MIT | Spark-relevant baseline for CPU/GPU inference + ggml tooling (pinned to a release tag). |
...
| DeepSeek-V4-Flash GGUF (teamblobfish) | `huggingface.co/teamblobfish/DeepSeek-V4-Flash-GGUF` | `refs/heads/main` | `ea169c118bf24bb3c3d4b6eb352729d3820cfdd6` | MIT | Sharded GGUF repo with multiple quant variants (IQ*/Q*); metadata-only fetch only; do not download weights without human approval. |
