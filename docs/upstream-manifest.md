...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `2f06867128e8a7f31517dae395cc01f326be1077` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
