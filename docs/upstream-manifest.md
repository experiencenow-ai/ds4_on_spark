...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `cfd3fd00d048d9a0013eb9a1a99bfb1c33c9d4ef` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
