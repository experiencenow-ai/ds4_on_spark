...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `335dbd60b49241f26ae2ca08b3307df1c702af58` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
