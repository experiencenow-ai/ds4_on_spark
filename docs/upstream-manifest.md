...
| Qwen3.5-27B (HF) | `huggingface.co/Qwen/Qwen3.5-27B` | `refs/heads/main` | `fc05daec18b0a78c049392ed2e771dde82bdf654` | Apache-2.0 | Dense-ish 27B comparison target (51.76 GiB safetensors); do not download weights without human approval; see `docs/upstream-qwen-dflash.md`. |
...
| DeepSeek-V4-Flash GGUF (teamblobfish) | `huggingface.co/teamblobfish/DeepSeek-V4-Flash-GGUF` | `refs/heads/main` | `71c338a6503e888223f31be9589520bfad14e4a8` | MIT | Sharded GGUF repo with multiple quant variants (IQ*/Q*); metadata-only fetch only; do not download weights without human approval. |
