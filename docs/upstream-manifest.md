...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `d3fd91ed9726cc87d3f2e67e758202d3982cde32` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
