...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `d08744238a64209cfe5ac64db039eaa44466aa85` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
