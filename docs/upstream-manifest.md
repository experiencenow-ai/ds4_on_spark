...
| DeepSeek-V4-Flash GGUF (antirez) | `huggingface.co/antirez/deepseek-v4-gguf` | `refs/heads/main` | `ef3b960827870d69ed0b225c095a617c12d7e80d` | MIT | Single-file IQ2XXS GGUF (~80.8 GiB) tuned for `ds4` and used as single-Spark candidate; do not download without human approval. |
