...
| --- | --- | --- | --- | --- | --- |
| ds4 | `antirez/ds4` | `refs/heads/main` | `d615ab08c8bce9b8242963ecece5aed6b5a79367` | MIT | DeepSeek-V4-Flash-specific native engine (Metal-first); semantics + KV-cache design reference (avoid weight downloads). |
