...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `a87fb399deaa709329258490834ca18858f95eec` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
