...
| --- | --- | --- | --- | --- | --- |
| ds4 | `antirez/ds4` | `refs/heads/main` | `920f9872ec98602e899c1f0bfec9f2f0f6103017` | MIT | DeepSeek-V4-Flash-specific native engine with Metal and CUDA graph paths; upstream README reports DGX Spark GB10 q2 `343.81` prefill t/s + `13.75` generation t/s; do not run upstream model-download scripts without human approval. |
...
| llama.cpp (ssweens DeepSeek V4 fork) | `ssweens/llama.cpp-deepseek-v4` | `refs/heads/main` | `1815221b810bea459e7f0b7e65d9df3f01b54bbd` | MIT | CUDA/ROCm/Vulkan fork used by `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` (IQ1_M + IQ2_XXS); validate Spark compatibility (CC/SM121 + memory/KV behavior). |
...
| DeepSeek-V4-Flash GGUF (antirez) | `huggingface.co/antirez/deepseek-v4-gguf` | `refs/heads/main` | `b0c3326275d2207e25e42bc8ac0704952466b5bb` | MIT | Single-file IQ2XXS GGUF (~80.8 GiB) tuned for `ds4` and used as single-Spark candidate; repo also publishes an optional MTP sidecar GGUF (~3.5 GiB); do not download without human approval. |
