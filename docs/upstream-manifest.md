...
| SGLang | `sgl-project/sglang` | `refs/heads/main` | `c7f674e427b066e54927af8fb95931f3a5f8c176` | Apache-2.0 | Serving runtime reference with explicit DeepSeek-V4 docs/tests (newer than latest release tag); track alongside vLLM for V4-Flash bring-up context. |
| llama.cpp | `ggml-org/llama.cpp` | `refs/tags/b9093` | `1e5ad35d560b90a8ac447d149c8f8447ae1fcaa0` | MIT | Spark-relevant baseline for CPU/GPU inference + ggml tooling (pinned to a release tag). |
