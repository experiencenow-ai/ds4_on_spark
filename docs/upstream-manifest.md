...
| --- | --- | --- | --- | --- | --- |
| ds4 | `antirez/ds4` | `refs/heads/main` | `8c1920934b1fce7bd9a3d8780bcbdc8d6e399557` | MIT | DeepSeek-V4-Flash-specific native engine with Metal and CUDA graph paths; upstream README reports DGX Spark GB10 q2 `343.81` prefill t/s + `13.75` generation t/s; do not run upstream model-download scripts without human approval. |
