...
| Kimi-K2.5-DFlash (HF) | `huggingface.co/z-lab/Kimi-K2.5-DFlash` | `refs/heads/main` | `e2db14df8337367b5eae8a6c206ea0d7d01a42a8` | MIT | Paired DFlash draft checkpoint (6.48 GiB safetensors) for exact target `moonshotai/Kimi-K2.5`; do not download weights without human approval; see `docs/upstream-qwen-dflash.md`. |
