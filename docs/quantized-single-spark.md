...
| `https://huggingface.co/antirez/deepseek-v4-gguf/resolve/c198a70525f1856f1bf50448f163471692c881f8/DeepSeek-V4-Flash-IQ2XXS-w2Q2K-AProjQ8-SExpQ8-OutQ8-chat-v2.gguf` | `llama.cpp` | `false` | `8388608` | `docs/gguf-inspect-antirez-c198a70-iq2xxs-chat-v2.json` |

MTP sidecar example (metadata-only inspection; 2026-05-10):

- `antirez/deepseek-v4-gguf` `DeepSeek-V4-Flash-MTP-Q4K-Q8_0-F32.gguf` @ `c198a70525f1856f1bf50448f163471692c881f8`:
  - Recorded output: `docs/gguf-inspect-antirez-c198a70-mtp-sidecar.json`
