...
== clock ==
utc: 2026-05-12T08:27:11Z
epoch: 1778574431
skew_s (remote-local): 1
NTPSynchronized=yes
TimeUSec=Tue 2026-05-12 17:27:11 KST
...
enp1s0f0np0 mtu=1500 state=UP
enp1s0f1np1 mtu=1500 state=UP
enP2p1s0f0np0 mtu=1500 state=UP
enP2p1s0f1np1 mtu=1500 state=UP
...
enP2p1s0f0np0 state=UP mtu=1500 speed_mbps=200000 duplex=full v4=<redacted-ipv4cidr> v6=<redacted-ipv6>/64
enP2p1s0f1np1 state=UP mtu=1500 speed_mbps=200000 duplex=full v4=<redacted-ipv4cidr> v6=<redacted-ipv6>/64
enP7s7 state=UP mtu=9000 speed_mbps=10000 duplex=full v4=<redacted-ipv4cidr> v6=<redacted-ipv6>/64
enp1s0f0np0 state=UP mtu=1500 speed_mbps=200000 duplex=full v4=<redacted-ipv4cidr> v6=<redacted-ipv6>/64
enp1s0f1np1 state=UP mtu=1500 speed_mbps=200000 duplex=full v4=<redacted-ipv4cidr> v6=<redacted-ipv6>/64
...
/dev/nvme0n1p2  3.7T  264G  3.3T   8% /
