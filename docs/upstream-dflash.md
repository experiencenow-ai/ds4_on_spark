...
| 8 | `moonshotai/Kimi-K2.6` | `refs/heads/main` | `81bcaaa7947338ce2641983d98947bca0cc1a4d4` | `other` | 554.30 GiB | `z-lab/Kimi-K2.6-DFlash` | `c1462ef46589f6ccb3eca424bffef94d72354ea9` | `mit` | 6.48 GiB | no | Target weights are far beyond single-Spark; keep as a paired DFlash provenance reference only. |
