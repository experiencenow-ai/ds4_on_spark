...
| 5 | `MiniMaxAI/MiniMax-M2.7` | `refs/heads/main` | `d494266a4affc0d2995ba1fa35c8481cbd84294b` | `other` | 214.33 GiB | `z-lab/MiniMax-M2.7-DFlash` | `6776d46e03667fc381becf652938645639e279bb` (HF API) | `UNKNOWN` | 1.04 GiB | no | Target weights are not single-Spark plausible. Draft metadata is visible via HF API, but raw model card fetch returned HTTP 401 at the pinned SHA; treat license as unknown until verified. |
