...
down (remote->mac) 16 MiB: 16777216 bytes transferred in 0.529314 secs (31696150 bytes/sec) [MiB/s=30.2 Mbit/s=253.6]
up (mac->remote) 16 MiB: 16777216 bytes (17 MB, 16 MiB) copied, 0.0875959 s, 192 MB/s [MiB/s=182.7 Mbit/s=1532.2]
...
dd: 0 bytes transferred in 5.004915 secs (0 bytes/sec)
failed
...
dd: 0 bytes transferred in 5.005288 secs (0 bytes/sec)
failed
up (mac->remote) 16 MiB: ssh status: resolve_failed
ssh: ssh: Could not resolve hostname spark2.local: nodename nor servname provided, or not known
failed
