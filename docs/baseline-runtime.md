...
- llama.cpp: `LLAMA_DIR`, `MODEL_GGUF`, `LLAMA_CLI`, `RUNTIME_LABEL`, `MODEL_SOURCE`, `MODEL_QUANT`, `LLAMA_PROMPT`, `CTX`, `N_TOKENS`, `N_GPU_LAYERS`, `EXTRA_ARGS`, `LLAMA_SERVER_SWEEP`, `LLAMA_SERVER`, `LLAMA_SERVER_SWEEP_PORT`, `LLAMA_SERVER_SWEEP_CTX`, `LLAMA_SERVER_SWEEP_PROMPT_WORDS`, `LLAMA_SERVER_SWEEP_N_PREDICT`, `LLAMA_SERVER_SWEEP_REPEATS`, `LLAMA_SERVER_SWEEP_CACHE_PROMPT`, `LLAMA_SERVER_SWEEP_WAIT_TIMEOUT_S`, `LLAMA_SERVER_SWEEP_POLL_S`, `LLAMA_SERVER_SWEEP_KEEP_SERVER`, `LLAMA_SERVER_SWEEP_SCRAPE_METRICS`, `LLAMA_SERVER_SWEEP_METRICS_TIMEOUT_S`, `LLAMA_SERVER_SWEEP_SERVER_ARGS`
