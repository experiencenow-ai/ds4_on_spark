...
- `scripts/run_baseline_existing_runtime.sh`: `LLAMA_SERVER_SWEEP`, `LLAMA_SERVER_THROUGHPUT_SWEEP`, `LLAMA_SERVER` + `LLAMA_SERVER_*` knobs, `LLAMA_FATTN_PATCH_PROBE`, `LLAMA_MULTISLOT_PATCH_PROBE`
