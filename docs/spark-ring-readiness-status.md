...
Status as of `2026-05-13T0527Z` (UTC).

## Latest commit-safe snapshots

- Mac discovery (mDNS + reachability): `docs/spark-ring-mac-discovery-2026-05-13T0527Z.md`
- Ring probe (clock + network + GPU/storage facts): `docs/spark-ring-probe-2026-05-13T0527Z.md`
- Ring SSH latency probe (Mac<->host, best-effort): `docs/spark-ring-latency-probe-2026-05-13T0527Z.md`
- Ring MTU probe (DF ping payloads): `docs/spark-ring-mtu-probe-2026-05-13T0527Z.md`
- Ring bandwidth probe (Mac<->host, best-effort): `docs/spark-ring-bw-probe-2026-05-13T0527Z.md`
- Spark0 facts-only probe (refreshed): `docs/spark0-probe-facts-2026-05-13T0527Z.md`
- Per-node facts-only probes:
  - `docs/spark-ring-node-facts-aitopatom-9ab9.local-2026-05-13T0527Z.md`
  - `docs/spark-ring-node-facts-spark1.local-2026-05-13T0527Z.md`
  - `docs/spark-ring-node-facts-spark2.local-2026-05-13T0527Z.md`

## Snapshot command (commit-safe)

```bash
stamp="2026-05-13T0527Z"
...
| Mac ping RTT/loss (ICMP) | partial (resolves; 100% loss at `2026-05-13T0527Z`; previously 0% loss at `2026-05-13T0435Z`) | blocked (DNS fail) | blocked (DNS fail) |
