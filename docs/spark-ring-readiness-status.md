...
Status as of `2026-05-13T0759Z` (UTC).

## Latest commit-safe snapshots

- Mac discovery (mDNS + reachability): `docs/spark-ring-mac-discovery-2026-05-13T0759Z.md`
- Ring probe (clock + network + GPU/storage facts): `docs/spark-ring-probe-2026-05-13T0759Z.md`
- Ring SSH latency probe (Mac<->host, best-effort): `docs/spark-ring-latency-probe-2026-05-13T0759Z.md`
- Ring MTU probe (DF ping payloads): `docs/spark-ring-mtu-probe-2026-05-13T0759Z.md`
- Ring bandwidth probe (Mac<->host, best-effort): `docs/spark-ring-bw-probe-2026-05-13T0759Z.md`
- Spark0 facts-only probe (refreshed): `docs/spark0-probe-facts-2026-05-13T0759Z.md`
- Per-node facts-only probes:
  - `docs/spark-ring-node-facts-aitopatom-9ab9.local-2026-05-13T0759Z.md`
  - `docs/spark-ring-node-facts-spark1.local-2026-05-13T0759Z.md`
  - `docs/spark-ring-node-facts-spark2.local-2026-05-13T0759Z.md`

## Snapshot command (commit-safe)

```bash
stamp="2026-05-13T0759Z"
...
| SSH latency (best-effort) | OK (`p50 ~320ms`, SSH wall-time) | missing | missing |
...
| Mac ping RTT/loss (ICMP) | partial (resolves; 0% loss at `2026-05-13T0759Z`; historically flaky, including 100% loss at `2026-05-13T0730Z`) | blocked (DNS fail) | blocked (DNS fail) |
