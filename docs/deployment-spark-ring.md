...
Optional: keep the ordered inventory in a file (any newline-delimited list of `<user>@<host>` works; see `deploy/config/inventory.ds4.spark012.example` for the format):
