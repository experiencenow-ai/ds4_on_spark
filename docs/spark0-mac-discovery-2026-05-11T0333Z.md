# Spark0 Mac Discovery (2026-05-11T0333Z)
...
```bash
(REDACT=1 DS4_GIT_DIR=.codex_git DS4_GIT_WORK_TREE=. ./scripts/mac_spark_discovery.sh aitopatom-9ab9.local spark1.local) | tee /private/tmp/ds4_mac_spark_discovery_redacted_2026-05-11T0333Z.txt
```
...
<redacted-ipv4>      <redacted-mac>  UHLWIi                en1   1174
<redacted-ipv4>      <redacted-mac>   UHLWI                 en1      !
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>      <redacted-mac>  UHLWIir               en1   1187
...
DATE: ---Mon 11 May 2026---
 3:33:11.822  ...STARTING...
Timestamp     A/R    Flags  if Domain               Service Type         Instance Name
 3:33:11.822  Add        3  10 local.               _ssh._tcp.           aitopatom-9ab9 SSH
 3:33:11.823  Add        3   1 local.               _ssh._tcp.           Mac Studio
 3:33:11.823  Add        3  26 local.               _ssh._tcp.           Mac Studio
 3:33:11.823  Add        3  10 local.               _ssh._tcp.           Mac Studio
 3:33:11.823  Add        2  26 local.               _ssh._tcp.           aitopatom-9ab9 SSH

== mdns resolution, 3 seconds each ==
-- aitopatom-9ab9.local --
DATE: ---Mon 11 May 2026---
 3:33:16.837  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
 3:33:16.838  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv6>%en0  120
 3:33:16.839  Add  40000003      26  aitopatom-9ab9.local.                  <redacted-ipv6>%en1  120
 3:33:16.839  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv4>                                     120
 3:33:16.839  Add  40000002      26  aitopatom-9ab9.local.                  <redacted-ipv4>                                120
-- spark1.local --
