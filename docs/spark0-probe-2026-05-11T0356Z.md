...
```bash
(REDACT=1 SPARK_PROBE_SUMMARY=1 SPARK_KNOWN_HOSTS_PER_HOST=1 DS4_GIT_DIR=.codex_git DS4_GIT_WORK_TREE=. SPARK_SSH_USER=spark0 ./scripts/spark_probe.sh aitopatom-9ab9.local spark1.local || true) | tee /private/tmp/ds4_spark01_probe_summary_redacted_2026-05-11T0356Z.txt
```
...
0, 0000000F:01:00.0, [N/A], 12.33, 2398, 2398, [N/A], 0, 0
