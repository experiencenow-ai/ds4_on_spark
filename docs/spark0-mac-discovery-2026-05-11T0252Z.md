# Spark0 Mac Discovery (2026-05-11T0252Z)
...
```bash
(REDACT=1 DS4_GIT_DIR=.codex_git DS4_GIT_WORK_TREE=. ./scripts/mac_spark_discovery.sh aitopatom-9ab9.local spark1.local) | tee /private/tmp/ds4_mac_spark_discovery_redacted_2026-05-11T0252Z.txt
```
...
<redacted-ipv4>      <redacted-mac>  UHLWIi                en1   1081
<redacted-ipv4>      <redacted-mac>   UHLWI                 en1   1118
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>      <redacted-mac>  UHLWIir               en1   1197
...
DATE: ---Mon 11 May 2026---
 2:54:29.864  ...STARTING...
Timestamp     A/R    Flags  if Domain               Service Type         Instance Name
 2:54:29.864  Add        3  26 local.               _ssh._tcp.           aitopatom-9ab9 SSH
 2:54:29.864  Add        3   1 local.               _ssh._tcp.           Mac Studio
 2:54:29.864  Add        3  26 local.               _ssh._tcp.           Mac Studio
 2:54:29.865  Add        3  10 local.               _ssh._tcp.           Mac Studio
 2:54:29.865  Add        2  10 local.               _ssh._tcp.           aitopatom-9ab9 SSH

== mdns resolution, 3 seconds each ==
-- aitopatom-9ab9.local --
DATE: ---Mon 11 May 2026---
 2:54:34.871  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
 2:54:34.872  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv6>%en0  120
 2:54:34.872  Add  40000002      10  aitopatom-9ab9.local.                  <redacted-ipv4>                                     120
-- spark1.local --
