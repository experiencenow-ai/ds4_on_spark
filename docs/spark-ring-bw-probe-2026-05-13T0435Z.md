...
down (remote->mac) 16 MiB: 16777216 bytes transferred in 0.676374 secs (24804644 bytes/sec) [MiB/s=23.7 Mbit/s=198.4]
up (mac->remote) 16 MiB: 16777216 bytes (17 MB, 16 MiB) copied, 0.0762698 s, 220 MB/s [MiB/s=209.8 Mbit/s=1759.8]
...
dd: 0 bytes transferred in 5.005080 secs (0 bytes/sec)
failed
...
dd: 0 bytes transferred in 5.004733 secs (0 bytes/sec)
failed
up (mac->remote) 16 MiB: ssh status: resolve_failed
ssh: ssh: Could not resolve hostname spark2.local: nodename nor servname provided, or not known
failed
