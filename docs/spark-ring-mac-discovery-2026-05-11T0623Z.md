== meta ==
Mon May 11 06:24:00 UTC 2026
git: 5e19d9f
targets: aitopatom-9ab9.local spark1.local spark2.local spark3.local
...
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1   1117
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1      !
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1    995
<redacted-ipv4>      <redacted-mac>   UHLWI                 en1      !
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1   1001
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1      !
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>      <redacted-mac>  UHLWIir               en1   1179
...
DATE: ---Mon 11 May 2026---
 6:24:00.392  ...STARTING...
Timestamp     A/R    Flags  if Domain               Service Type         Instance Name
 6:24:00.393  Add        3   1 local.               _ssh._tcp.           Mac Studio
 6:24:00.393  Add        3  10 local.               _ssh._tcp.           Mac Studio
 6:24:00.393  Add        3  10 local.               _ssh._tcp.           aitopatom-9ab9 SSH
 6:24:00.393  Add        3  26 local.               _ssh._tcp.           Mac Studio
 6:24:00.393  Add        2  26 local.               _ssh._tcp.           aitopatom-9ab9 SSH

== mdns resolution, 3 seconds each ==
-- aitopatom-9ab9.local --
DATE: ---Mon 11 May 2026---
 6:24:05.407  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
 6:24:05.408  Add  40000003      26  aitopatom-9ab9.local.                  <redacted-ipv6>%en1  120
 6:24:05.408  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv6>%en0  120
 6:24:05.408  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv4>                                     120
 6:24:05.409  Add  40000002      26  aitopatom-9ab9.local.                  <redacted-ipv4>                                120
-- spark1.local --
-- spark2.local --
-- spark3.local --
