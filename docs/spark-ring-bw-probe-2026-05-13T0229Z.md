...
down (remote->mac) 16 MiB: 16777216 bytes transferred in 2.020961 secs (8301603 bytes/sec) [MiB/s=7.9 Mbit/s=66.4]
up (mac->remote) 16 MiB: 16777216 bytes (17 MB, 16 MiB) copied, 0.994318 s, 16.9 MB/s [MiB/s=16.1 Mbit/s=135.0]
...
dd: 0 bytes transferred in 5.023180 secs (0 bytes/sec)
failed
...
dd: 0 bytes transferred in 5.024209 secs (0 bytes/sec)
failed
up (mac->remote) 16 MiB: ssh status: resolve_failed
ssh: ssh: Could not resolve hostname spark2.local: nodename nor servname provided, or not known
failed
