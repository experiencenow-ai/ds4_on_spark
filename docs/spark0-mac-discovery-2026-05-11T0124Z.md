# Spark0 Mac Discovery (2026-05-11T0124Z)
...
```bash
(REDACT=1 DS4_GIT_DIR=.git-codex DS4_GIT_WORK_TREE=. ./scripts/mac_spark_discovery.sh aitopatom-9ab9.local spark1.local) | tee /private/tmp/ds4_mac_spark_discovery_redacted_2026-05-11T0124Z.txt
```
...
<redacted-ipv4>      <redacted-mac>  UHLWIi                en1   1096
<redacted-ipv4>      <redacted-mac>   UHLWI                 en1    269
...
DATE: ---Mon 11 May 2026---
 1:24:24.825  ...STARTING...
Timestamp     A/R    Flags  if Domain               Service Type         Instance Name
 1:24:24.825  Add        3   1 local.               _ssh._tcp.           Mac Studio
 1:24:24.825  Add        3  10 local.               _ssh._tcp.           Mac Studio
 1:24:24.825  Add        3  10 local.               _ssh._tcp.           aitopatom-9ab9 SSH
 1:24:24.825  Add        3  26 local.               _ssh._tcp.           Mac Studio
 1:24:24.826  Add        2  26 local.               _ssh._tcp.           aitopatom-9ab9 SSH

== mdns resolution, 3 seconds each ==
-- aitopatom-9ab9.local --
DATE: ---Mon 11 May 2026---
 1:24:29.829  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
 1:24:29.830  Add  40000002      10  aitopatom-9ab9.local.                  <redacted-ipv6>%en0  120
 1:24:30.226  Add  2             26  aitopatom-9ab9.local.                  <redacted-ipv4>                                120
 1:24:30.265  Add  2             10  aitopatom-9ab9.local.                  <redacted-ipv4>                                     120
-- spark1.local --
