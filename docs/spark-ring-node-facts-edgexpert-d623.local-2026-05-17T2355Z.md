== local meta ==
Sun May 17 23:55:40 UTC 2026
git: 93cc51c
probe args: spark1@edgexpert-d623.local
resolved targets: spark1@edgexpert-d623.local
...
== identity ==
edgexpert-d623
uid=1000(spark1) gid=1000(spark1) groups=1000(spark1),4(adm),27(sudo),29(audio),30(dip),46(plugdev),100(users),122(lpadmin)
...
== clock ==
utc: 2026-05-17T23:55:40Z
epoch: 1779062140
NTPSynchronized=yes
TimeUSec=Mon 2026-05-18 08:55:40 KST
...
Mem:           121Gi        16Gi        47Gi       3.3Mi        58Gi       104Gi
Swap:           15Gi        66Mi        15Gi
...
lrwxrwxrwx 1 root root 22 Nov  5  2025 /usr/local/cuda -> /etc/alternatives/cuda
/usr/local/cuda-13.0
...
device0 cc: 12.1
device0 global mem (bytes): 130663866368
device0 sms: 48
...
== filesystems (mountinfo: / and /home) ==
/ ext4 rw,relatime
...
nvidia_uvm           1900544  0
nvidia_drm            135168  0
nvidia_modeset       1957888  2 nvidia_drm
nvidia              14675968  7 nvidia_uvm,nvidia_modeset
...
== /dev nvidia nodes ==
crw-rw-rw- 1 root root 195, 254 May 12 16:37 /dev/nvidia-modeset
crw-rw-rw- 1 root root 498,   0 May 12 16:37 /dev/nvidia-uvm
crw-rw-rw- 1 root root 498,   1 May 12 16:37 /dev/nvidia-uvm-tools
crw-rw-rw- 1 root root 195,   0 May 12 16:37 /dev/nvidia0
crw-rw-rw- 1 root root 195, 255 May 12 16:37 /dev/nvidiactl

/dev/nvidia-caps:
total 0
cr-------- 1 root root 501, 1 May 12 16:42 nvidia-cap1
cr--r--r-- 1 root root 501, 2 May 12 16:42 nvidia-cap2
