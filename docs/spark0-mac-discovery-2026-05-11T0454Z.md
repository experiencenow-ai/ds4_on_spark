# Spark0 Mac Discovery (2026-05-11T0454Z)

Targets:

- `aitopatom-9ab9.local` (Spark0)
- `spark1.local`

Commands run from the Mac:

```bash
(REDACT=1 DS4_GIT_DIR=.codex_git DS4_GIT_WORK_TREE=. ./scripts/mac_spark_discovery.sh aitopatom-9ab9.local spark1.local) | tee /private/tmp/ds4_mac_spark_discovery_redacted_2026-05-11T0454Z.txt
```

Notes:

- Output is redacted (`REDACT=1`) to remove IPv4/IPv6/MAC addresses.
- `route -n get <target>` is best-effort; in locked-down macOS environments it can print `Operation not permitted`.

## Discovery Output (Redacted)

```text
== meta ==
Mon May 11 04:54:49 UTC 2026
git: d131251
...
<redacted-ipv4>      <redacted-mac>  UHLWIi                en1   1166
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1   1105
...
<redacted-ipv4>/32   link#26            UCS                   en1      !
<redacted-ipv4>      <redacted-mac>  UHLWIir               en1   1176
...
DATE: ---Mon 11 May 2026---
 4:54:49.717  ...STARTING...
Timestamp     A/R    Flags  if Domain               Service Type         Instance Name
 4:54:49.717  Add        3   1 local.               _ssh._tcp.           Mac Studio
 4:54:49.717  Add        3  10 local.               _ssh._tcp.           Mac Studio
 4:54:49.717  Add        3  10 local.               _ssh._tcp.           aitopatom-9ab9 SSH
 4:54:49.717  Add        3  26 local.               _ssh._tcp.           Mac Studio
 4:54:49.717  Add        2  26 local.               _ssh._tcp.           aitopatom-9ab9 SSH

== mdns resolution, 3 seconds each ==
-- aitopatom-9ab9.local --
DATE: ---Mon 11 May 2026---
 4:54:54.724  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
 4:54:54.725  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv6>%en0  120
 4:54:54.725  Add  40000003      26  aitopatom-9ab9.local.                  <redacted-ipv6>%en1  120
 4:54:54.725  Add  40000003      10  aitopatom-9ab9.local.                  <redacted-ipv4>                                     120
 4:54:54.725  Add  40000002      26  aitopatom-9ab9.local.                  <redacted-ipv4>                                120
-- spark1.local --
