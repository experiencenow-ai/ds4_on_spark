...
- Mac→Spark0 ICMP ping is flaky (0% loss at `2026-05-12T1801Z`, `2026-05-12T2132Z`, and `2026-05-13T0435Z`; 100% loss at `2026-05-12T1830Z`, `2026-05-12T1934Z`, `2026-05-12T2029Z`, `2026-05-12T2058Z`, `2026-05-13T0005Z`, and `2026-05-13T0041Z`; see latest mac discovery snapshot).
- GPU: `NVIDIA GB10` (Blackwell), `compute_cap=12.1` (via `nvidia-smi` query + `nvcc` runtime probe)
- CUDA/driver (observed `2026-05-13T0435Z`): driver `580.142`, `nvidia-smi` CUDA `13.0`, `nvcc` `13.0.88` (installed at `/usr/local/cuda/bin/nvcc`, not on `$PATH`), `cuda version.json` `13.0.3`
- Stable Spark0 CUDA/toolchain quickref: `docs/spark0-cuda-toolchain-facts.md`
- Latest commit-safe ring snapshot set: `2026-05-13T0435Z` (`docs/spark-ring-*-2026-05-13T0435Z.md`)
- Latest Spark0 facts-only snapshot: `2026-05-13T0435Z` (`docs/spark0-probe-facts-2026-05-13T0435Z.md`)
- PCIe link note (observed `2026-05-13T0435Z`): `nvidia-smi` `pcie.link.gen.max/current` reports Gen1 x1, but `nvidia-smi -q` reports Gen5 x16 max; see the `warning:` lines in `docs/spark0-probe-facts-2026-05-13T0435Z.md`
