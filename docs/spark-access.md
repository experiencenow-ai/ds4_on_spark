...
- CUDA/driver (observed `2026-05-13T0759Z`): driver `580.142`, `nvidia-smi` CUDA `13.0`, `nvcc` `13.0.88` (installed at `/usr/local/cuda/bin/nvcc`, not on `$PATH`), `cuda version.json` `13.0.3`
- Stable Spark0 CUDA/toolchain quickref: `docs/spark0-cuda-toolchain-facts.md`
- Latest commit-safe ring snapshot set: `2026-05-13T0759Z` (`docs/spark-ring-*-2026-05-13T0759Z.md`)
- Latest Spark0 facts-only snapshot: `2026-05-13T0759Z` (`docs/spark0-probe-facts-2026-05-13T0759Z.md`)
- PCIe link note (observed `2026-05-13T0759Z`): `nvidia-smi` `pcie.link.gen.max/current` reports Gen1 x1, but `nvidia-smi -q` reports Gen5 x16 max; see the `warning:` lines in `docs/spark0-probe-facts-2026-05-13T0759Z.md`
