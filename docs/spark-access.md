...
- Mac→Spark0 ICMP ping is currently working (see latest mac discovery snapshot).
...
- Latest commit-safe ring snapshot set: `2026-05-12T1801Z` (`docs/spark-ring-*-2026-05-12T1801Z.md`)
- Latest Spark0 facts-only snapshot: `2026-05-12T1801Z` (`docs/spark0-probe-facts-2026-05-12T1801Z.md`)
- PCIe link note (observed 2026-05-12): `nvidia-smi` `pcie.link.gen.max/current` reports Gen1 x1, but `nvidia-smi -q` reports Gen5 x16 max; see the `warning:` lines in `docs/spark0-probe-facts-2026-05-12T1801Z.md`
