...
- Mac→Spark0 ICMP ping is flaky (0% loss at `2026-05-12T1801Z` and `2026-05-12T2132Z`, 100% loss at `2026-05-12T1830Z`, `2026-05-12T1934Z`, `2026-05-12T2029Z`, `2026-05-12T2058Z`, `2026-05-13T0005Z`, and `2026-05-13T0041Z`; see latest mac discovery snapshot).
...
- Latest commit-safe ring snapshot set: `2026-05-13T0041Z` (`docs/spark-ring-*-2026-05-13T0041Z.md`)
- Latest Spark0 facts-only snapshot: `2026-05-13T0041Z` (`docs/spark0-probe-facts-2026-05-13T0041Z.md`)
- PCIe link note (observed 2026-05-12): `nvidia-smi` `pcie.link.gen.max/current` reports Gen1 x1, but `nvidia-smi -q` reports Gen5 x16 max; see the `warning:` lines in `docs/spark0-probe-facts-2026-05-13T0041Z.md`
