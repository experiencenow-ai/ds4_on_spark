...
- Latest commit-safe snapshot set: `2026-05-12T1026Z` (`docs/spark-ring-*-2026-05-12T1026Z.md`, `docs/spark0-probe-facts-2026-05-12T1026Z.md`)
- PCIe link note (observed 2026-05-12): `nvidia-smi` `pcie.link.gen.max/current` reports Gen1 x1, but `nvidia-smi -q` reports Gen5 x16 max; see the `warning:` lines in `docs/spark0-probe-facts-2026-05-12T1026Z.md`
