...
down (remote->mac) 16 MiB: 16777216 bytes transferred in 0.363617 secs (46139801 bytes/sec) [MiB/s=44.0 Mbit/s=369.1]
up (mac->remote) 16 MiB: 16777216 bytes (17 MB, 16 MiB) copied, 0.0874098 s, 192 MB/s [MiB/s=183.0 Mbit/s=1535.5]

== target: spark0@spark1.local ==
down (remote->mac) 16 MiB: 0 bytes transferred in 5.005443 secs (0 bytes/sec)
...
down (remote->mac) 16 MiB: 0 bytes transferred in 5.005426 secs (0 bytes/sec)
