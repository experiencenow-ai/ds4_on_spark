== meta ==
Sun May 17 23:55:10 UTC 2026
git: 93cc51c
targets: spark0@aitopatom-9ab9.local spark1@edgexpert-d623.local
...
<redacted-ipv4>      <redacted-mac>  UHLWIi                en1   1138
<redacted-ipv4>      <redacted-mac>  UHLWIi                en1   1185
<redacted-ipv4>      <redacted-mac>  UHLWI                 en1    975
...
23:55:10.433  ...STARTING...
Timestamp     A/R    Flags  if Domain               Service Type         Instance Name
23:55:10.433  Add        3   1 local.               _ssh._tcp.           Mac Studio
23:55:10.434  Add        3  26 local.               _ssh._tcp.           Mac Studio
23:55:10.434  Add        3  10 local.               _ssh._tcp.           Mac Studio
23:55:10.434  Add        3  10 local.               _ssh._tcp.           aitopatom-9ab9 SSH
23:55:10.434  Add        3  26 local.               _ssh._tcp.           aitopatom-9ab9 SSH
23:55:10.434  Add        2  26 local.               _ssh._tcp.           edgexpert-d623 SSH

== mdns resolution, 3 seconds each ==
-- aitopatom-9ab9.local --
DATE: ---Sun 17 May 2026---
23:55:15.444  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
23:55:15.445  Add  40000003      26  aitopatom-9ab9.local.                  <redacted-ipv6>%en1  120
23:55:15.445  Add  40000002      26  aitopatom-9ab9.local.                  <redacted-ipv4>                                120
-- edgexpert-d623.local --
DATE: ---Sun 17 May 2026---
23:55:18.456  ...STARTING...
Timestamp     A/R  Flags         IF  Hostname                               Address                                      TTL
23:55:18.457  Add  40000003      26  edgexpert-d623.local.                  <redacted-ipv6>%en1  120
23:55:18.457  Add  40000002      26  edgexpert-d623.local.                  <redacted-ipv4>                                120

== route selection (macOS) ==
-- aitopatom-9ab9.local --
route: permission_denied (sandbox?)
-- edgexpert-d623.local --
route: permission_denied (sandbox?)

== known target checks ==
spark0@aitopatom-9ab9.local: ssh reachable
spark1@edgexpert-d623.local: ssh reachable

== ping (mac->targets, compact) ==
aitopatom-9ab9.local: tx=3 rx=3 loss=0.0% rtt_avg_ms=73.651
edgexpert-d623.local: tx=3 rx=3 loss=0.0% rtt_avg_ms=233.219
