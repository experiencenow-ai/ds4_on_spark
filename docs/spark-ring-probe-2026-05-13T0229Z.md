...
== clock ==
utc: 2026-05-13T02:29:57Z
epoch: 1778639397
skew_s (remote-local): 2
NTPSynchronized=yes
TimeUSec=Wed 2026-05-13 11:29:57 KST
...
/dev/nvme0n1p2  3.7T  270G  3.3T   8% /
...
aitopatom-9ab9.local epoch=1778639397 skew_s=2
spark1.local epoch=? skew_s=?
spark2.local epoch=? skew_s=?

skew span_s: 0 (min=2 max=2)
