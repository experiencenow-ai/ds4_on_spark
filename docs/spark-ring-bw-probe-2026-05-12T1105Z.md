...
down (remote->mac) 16 MiB: 16777216 bytes transferred in 1.852390 secs (9057065 bytes/sec) [MiB/s=8.6 Mbit/s=72.5]
up (mac->remote) 16 MiB: 16777216 bytes (17 MB, 16 MiB) copied, 0.836252 s, 20.1 MB/s [MiB/s=19.1 Mbit/s=160.5]
...
dd: 0 bytes transferred in 5.005213 secs (0 bytes/sec)
failed
...
dd: 0 bytes transferred in 5.003465 secs (0 bytes/sec)
failed
up (mac->remote) 16 MiB: ssh status: resolve_failed
ssh: ssh: Could not resolve hostname spark2.local: nodename nor servname provided, or not known
failed
