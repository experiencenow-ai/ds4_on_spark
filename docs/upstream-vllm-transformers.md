...
- Ampere SM86 patch set: `https://github.com/Lasimeri/vllm-dsv4-ampere` (`refs/heads/master`, `06f6f6058834907b7db490f440baa443787a0666`)
  - Purpose: replaces SM90+ DeepGEMM/FlashMLA kernels with pyref/Triton fallbacks to run V4-Flash on RTX 30xx-class GPUs.
  - Note: no `LICENSE*` file detected at the pinned commit; treat as license-unknown reference material only (see `docs/upstream-manifest.md`).
