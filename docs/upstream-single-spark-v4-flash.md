...
| --- | --- | --- | --- | ---: | --- | --- |
| A | `ssweens/llama.cpp-deepseek-v4` (`9f19428fc7bd2a0ac05a083c1430235174aaf811`) | `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` IQ1_M (`cd14d4663786e5fa368e560324b10e92110f39c2`) | MIT / MIT | 62.9 | Plausible | Most headroom for KV/cache among pinned GGUF candidates; runtime is a DeepSeek-V4-capable llama.cpp fork (CPU/CUDA/ROCm/Vulkan claimed). |
| B | `ssweens/llama.cpp-deepseek-v4` (`9f19428fc7bd2a0ac05a083c1430235174aaf811`) | `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` IQ2_XXS shards (`cd14d4663786e5fa368e560324b10e92110f39c2`) | MIT / MIT | 72.6 | Plausible | Sharded; requires the same V4-capable llama.cpp fork; verify shard auto-load behavior + KV/cache sizing. |
