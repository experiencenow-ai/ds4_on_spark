...
| H | `antirez/ds4` (`ae302c2fa18cc6d9aefc021d0f27ae03c9ad2fc0`) | `antirez/deepseek-v4-gguf` IQ2XXS (`9cb905d99321dbefb0e7c63fdb9bbd4d8aa7126a`) | MIT / MIT | 80.8 | Not Spark-ready (runtime mismatch) | `ds4` is Metal-first (macOS); useful for semantics/KV-cache reference, but not a direct Spark runtime today. |
