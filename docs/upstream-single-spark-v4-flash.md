...
| C | `kamnxt/llama.cpp-deepseek-v4-flash-cuda-spark` (`9222e55c13c965ccb7e9104fda58796edd84a732`) | `antirez/deepseek-v4-gguf` IQ2XXS (`3274cdc42be178f7384211c7463565dccfc444d7`) | MIT / MIT | 80.8 | Plausible | Reported running on a single GB10-class Spark: `https://forums.developer.nvidia.com/t/deepseek-v4-flash-iq2xxs-on-a-single-gb10/368970` |
...
| H | `antirez/ds4` (`8809b90a1e3247389d7652b565ab6772e036f1ea`) | `antirez/deepseek-v4-gguf` IQ2XXS (`3274cdc42be178f7384211c7463565dccfc444d7`) | MIT / MIT | 80.8 | Plausible | Upstream `ds4` now includes a CUDA path and reports DGX Spark GB10 q2 `7047` prompt tokens at `343.81` prefill t/s + `13.75` generation t/s. Reproduce locally before treating as our result. |
