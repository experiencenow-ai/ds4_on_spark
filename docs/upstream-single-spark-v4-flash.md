...
| H | `antirez/ds4` (`320b7793bdfa3928750050df58406aac6ac8015d`) | `antirez/deepseek-v4-gguf` IQ2XXS (`c566ab6d7c696ddd0c7f124e115228af1a326824`) | MIT / MIT | 80.8 | Plausible | Upstream `ds4` now includes a CUDA path and reports DGX Spark GB10 q2 `7047` prompt tokens at `343.81` prefill t/s + `13.75` generation t/s. Reproduce locally before treating as our result. |
