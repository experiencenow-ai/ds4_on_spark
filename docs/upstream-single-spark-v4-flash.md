...
| H | `antirez/ds4` (`3630e64ea2aadb4d069a30dc3369f2b2950d6cb3`) | `antirez/deepseek-v4-gguf` IQ2XXS (`c566ab6d7c696ddd0c7f124e115228af1a326824`) | MIT / MIT | 80.8 | Plausible | Upstream `ds4` now includes a CUDA path and reports DGX Spark GB10 q2 `7047` prompt tokens at `343.81` prefill t/s + `13.75` generation t/s. Reproduce locally before treating as our result. |
