...
| B | `ssweens/llama.cpp-deepseek-v4` (`9f19428fc7bd2a0ac05a083c1430235174aaf811`) | `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` IQ2_XXS shards (`cd14d4663786e5fa368e560324b10e92110f39c2`) | MIT / MIT | 72.6 | Plausible | None | Sharded; requires the same V4-capable llama.cpp fork; verify shard auto-load behavior + KV/cache sizing. |
