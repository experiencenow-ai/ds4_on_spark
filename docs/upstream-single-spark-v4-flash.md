...
| --- | --- | --- | --- | ---: | --- | --- |
| A | `ssweens/llama.cpp-deepseek-v4` (`bb648b31e137a44b1ee72907e20ad8fb1f21d644`) | `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` IQ1_M (`4e4b871229437d9e56aef57c7fa4977425a8dc2b`) | MIT / MIT | 62.9 | Plausible | Most headroom for KV/cache among pinned GGUF candidates; runtime is a DeepSeek-V4-capable llama.cpp fork (CPU/CUDA/ROCm/Vulkan claimed). |
| B | `ssweens/llama.cpp-deepseek-v4` (`bb648b31e137a44b1ee72907e20ad8fb1f21d644`) | `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` IQ2_XXS shards (`4e4b871229437d9e56aef57c7fa4977425a8dc2b`) | MIT / MIT | 72.6 | Plausible | Sharded; requires the same V4-capable llama.cpp fork; verify shard auto-load behavior + KV/cache sizing. |
| J | `ssweens/llama.cpp-deepseek-v4` (`bb648b31e137a44b1ee72907e20ad8fb1f21d644`) | `ssweens/DeepSeek-V4-Flash-GGUF-YMMV` IQ3_XXS (`4e4b871229437d9e56aef57c7fa4977425a8dc2b`) | MIT / MIT | 104.2 | Plausible but tight | Leaves limited headroom for KV/cache on Spark0 baseline; keep as a reference in case IQ1/2 variants regress. |
