...
| H | `antirez/ds4` (`8c1920934b1fce7bd9a3d8780bcbdc8d6e399557`) | `antirez/deepseek-v4-gguf` IQ2XXS (`3274cdc42be178f7384211c7463565dccfc444d7`) | MIT / MIT | 80.8 | Plausible | Upstream `ds4` now includes a CUDA path and reports DGX Spark GB10 q2 `7047` prompt tokens at `343.81` prefill t/s + `13.75` generation t/s. Reproduce locally before treating as our result. |
