...
down (remote->mac) 16 MiB: 16777216 bytes transferred in 0.348960 secs (48077762 bytes/sec) [MiB/s=45.9 Mbit/s=384.6]
up (mac->remote) 16 MiB: 16777216 bytes (17 MB, 16 MiB) copied, 0.0971857 s, 173 MB/s [MiB/s=164.6 Mbit/s=1381.0]
...
dd: 0 bytes transferred in 5.004442 secs (0 bytes/sec)
failed
...
dd: 0 bytes transferred in 5.004886 secs (0 bytes/sec)
failed
up (mac->remote) 16 MiB: ssh status: resolve_failed
ssh: ssh: Could not resolve hostname spark2.local: nodename nor servname provided, or not known
failed
