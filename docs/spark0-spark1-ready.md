...
- For a copy/paste shim setup recipe (`git init .git-codex` + `git --git-dir=... fetch/checkout`), see `docs/spark-access.md` under “Git Shim For Read-Only Checkouts (`.git-codex`)”.
