...
- `spark1.local` is not reachable yet (as of the 22:25Z refresh, it failed DNS resolution from the Mac probe environment; likely not provisioned / not on the same mDNS domain).
