...
- The K=2 direct verifier is a real speed path only when repeat-run acceptance stays full; current one-setup repeat evidence is blocked by process/cache drift after several generations.
