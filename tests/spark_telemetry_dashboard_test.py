...
class SparkTelemetryDashboardTest(unittest.TestCase):
    ...
    def test_dashboard_includes_dsapi_chat_console(self):
        ...
        self.assertIn('id="chat-thinking"', dashboard.DASHBOARD_HTML)
        ...
        self.assertIn("thinking_budget_tokens:thinking", dashboard.DASHBOARD_HTML)
        self.assertIn("function chatThinkingBudget()", dashboard.DASHBOARD_HTML)
