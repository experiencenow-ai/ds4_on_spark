...
BASE_LOG = """\
ds4: mtp bench phase=session_baseline command_sha256=abc prompt_sha256=def n_predict=32 mtp_draft=2 ctx=2048 seed=1234 spec_disabled=1
ds4: prefill: 7.00 t/s, generation: 2.20 t/s
ds4: mtp bench phase=session_baseline external_wall_s=70.000000 exit_code=0 n_predict=32 mtp_draft=2 ctx=2048 seed=1234 spec_disabled=1
"""

MTP_LOG = """\
ds4: mtp bench phase=mtp_draft2 command_sha256=abc prompt_sha256=def n_predict=32 mtp_draft=2 ctx=2048 seed=1234 spec_disabled=0
...
ds4: mtp bench phase=mtp_draft2 external_wall_s=71.000000 exit_code=0 n_predict=32 mtp_draft=2 ctx=2048 seed=1234 spec_disabled=0
"""
