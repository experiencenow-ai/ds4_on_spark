...
DS4_MTP_MEASURED_MODE="${DS4_MTP_MEASURED_MODE:-0}"
export DS4_MTP_MEASURED_MODE
if [ "$DS4_MTP_MEASURED_MODE" = "1" ]; then
	DS4_MTP_CONF_LOG="${DS4_MTP_CONF_LOG:-0}"
	DS4_MTP_TIMING="${DS4_MTP_TIMING:-0}"
else
	DS4_MTP_CONF_LOG="${DS4_MTP_CONF_LOG:-1}"
	DS4_MTP_TIMING="${DS4_MTP_TIMING:-1}"
fi
DS4_MTP_MIN_MARGIN="${DS4_MTP_MIN_MARGIN:-0}"
export DS4_MTP_MIN_MARGIN
if [ "$DS4_MTP_CONF_LOG" = "0" ]; then
	unset DS4_MTP_CONF_LOG
else
	export DS4_MTP_CONF_LOG
fi
...
PERF_ENV_KEYS = (
	...
	"DS4_MTP_EXACT_SERIAL_COLLAPSE_BATCH_HEAD",
	"DS4_MTP_EXACT_SERIAL_HEAD",
	"DS4_MTP_EXACT_SERIAL_ROW_Q8_HEAD",
	"DS4_MTP_EXACT_SERIAL_TOP1_HEAD",
	"DS4_MTP_EXACT_SUFFIX3",
	"DS4_MTP_EXACT_TOP1_HEAD",
	"DS4_MTP_FULL_LOGITS",
	"DS4_MTP_MEASURED_MODE",
	"DS4_MTP_ROW0_FULL_LOGITS",
	"DS4_MTP_ROW0_TOP1_HEAD",
	"DS4_MTP_ROW2_FULL_LOGITS",
	"DS4_MTP_ROW2_TOP1_CONT",
	"DS4_MTP_PARTIAL_TOP1_CONT",
	"DS4_MTP_SAMPLE_DIAG",
	"DS4_MTP_SESSION",
