...
if [ -x /usr/local/cuda/bin/nvcc ]; then
	...
	cd \"$REMOTE_DIR\"
	make clean
	make bin/cuda_sm121_compile_probe.o bin/cuda_sm121_probe bin/cuda_sm121_arch_report bin/cuda_cublaslt_smoke bin/cuda_cublaslt_fp8_smoke bin/cuda_cublaslt_fp8_e5m2_smoke bin/cuda_sm121_smem_optin bin/cuda_sm121_devattrs bin/cuda_sm121_fp8_conv bin/cuda_sm121_pipeline_memcpy_async bin/cuda_sm120_compat_probe bin/cuda_sm121_barrier_memcpy_async bin/cuda_sm121_cccl_atomic_ref bin/cuda_sm121_cxx20_probe bin/cuda_sm121_wmma_smoke bin/cuda_sm121_cluster_launch bin/cuda_sm121_nvrtc_jit bin/cuda_sm121_nvjitlink_jit
"
