...
from scripts._lib.llamacpp_server import scan_fattn_reservation as shared_scan_fattn_reservation
from scripts._lib.llamacpp_server import split_ints
from scripts._lib.llamacpp_server import split_opt_ints
from scripts._lib.llamacpp_server import wait_health


def scan_fattn_reservation(log_path):
    return shared_scan_fattn_reservation(
        log_path,
        match_limit=250,
        include_node_samples=False,
        op_kind_format=True,
        include_sched_reserve_match=True,
    )
