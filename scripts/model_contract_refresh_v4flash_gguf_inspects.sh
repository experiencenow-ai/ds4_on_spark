...
PINNED_ANTIREZ_TRUNK_URL="https://huggingface.co/antirez/deepseek-v4-gguf/resolve/3274cdc42be178f7384211c7463565dccfc444d7/DeepSeek-V4-Flash-IQ2XXS-w2Q2K-AProjQ8-SExpQ8-OutQ8-chat-v2.gguf"
PINNED_ANTIREZ_MTP_SIDECAR_URL="https://huggingface.co/antirez/deepseek-v4-gguf/resolve/3274cdc42be178f7384211c7463565dccfc444d7/DeepSeek-V4-Flash-MTP-Q4K-Q8_0-F32.gguf"
...
refresh_one \
  ...
  "$OUT_DIR/gguf-inspect-antirez-3274cdc-iq2xxs-chat-v2.json"

refresh_one \
  "$PINNED_ANTIREZ_MTP_SIDECAR_URL" \
  "$OUT_DIR/gguf-inspect-antirez-3274cdc-mtp-sidecar.json"

# Combined trunk+sidecar view (artifact-set-level fingerprints + MTP trust signal).
refresh_combined \
  "$PINNED_ANTIREZ_TRUNK_URL" \
  "$PINNED_ANTIREZ_MTP_SIDECAR_URL" \
  "$OUT_DIR/gguf-inspect-antirez-3274cdc-iq2xxs-chat-v2-mtp-set.json"

refresh_probe \
  "$PINNED_ANTIREZ_MTP_SIDECAR_URL" \
  "$OUT_DIR/mtp-sidecar-probe-antirez-3274cdc.json"

refresh_probe_strong \
  "$PINNED_ANTIREZ_MTP_SIDECAR_URL" \
  "$OUT_DIR/mtp-sidecar-probe-antirez-3274cdc-payload64.json"
