...
PINNED_ANTIREZ_TRUNK_URL="https://huggingface.co/antirez/deepseek-v4-gguf/resolve/9cb905d99321dbefb0e7c63fdb9bbd4d8aa7126a/DeepSeek-V4-Flash-IQ2XXS-w2Q2K-AProjQ8-SExpQ8-OutQ8-chat-v2.gguf"
PINNED_ANTIREZ_MTP_SIDECAR_URL="https://huggingface.co/antirez/deepseek-v4-gguf/resolve/9cb905d99321dbefb0e7c63fdb9bbd4d8aa7126a/DeepSeek-V4-Flash-MTP-Q4K-Q8_0-F32.gguf"
...
refresh_combined \
  "$PINNED_ANTIREZ_TRUNK_URL" \
  "$PINNED_ANTIREZ_MTP_SIDECAR_URL" \
  "$OUT_DIR/gguf-inspect-antirez-9cb905d-iq2xxs-chat-v2-mtp-set.json"
