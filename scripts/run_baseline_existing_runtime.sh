...
LLAMA_SERVER_SWEEP_SCRAPE_METRICS="${LLAMA_SERVER_SWEEP_SCRAPE_METRICS:-0}"
LLAMA_SERVER_SWEEP_METRICS_TIMEOUT_S="${LLAMA_SERVER_SWEEP_METRICS_TIMEOUT_S:-20}"
...
LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET="${LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET:-}"
LLAMA_SERVER_THROUGHPUT_SWEEP_PORT="${LLAMA_SERVER_THROUGHPUT_SWEEP_PORT:-18082}"
LLAMA_SERVER_THROUGHPUT_SWEEP_CTX="${LLAMA_SERVER_THROUGHPUT_SWEEP_CTX:-}"
LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS="${LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS:-4096}"
LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT="${LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT:-32}"
LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS="${LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS:-1}"
LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT="${LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT:-0}"
LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY="${LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY:-1 2 4 8}"
LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES="${LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES:-1 2}"
LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES="${LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES:-}"
LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES="${LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES:-}"
LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S="${LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S:-1200}"
LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S="${LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S:-5}"
LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER="${LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER:-0}"
LLAMA_SERVER_THROUGHPUT_SWEEP_SCRAPE_METRICS="${LLAMA_SERVER_THROUGHPUT_SWEEP_SCRAPE_METRICS:-0}"
LLAMA_SERVER_THROUGHPUT_SWEEP_METRICS_TIMEOUT_S="${LLAMA_SERVER_THROUGHPUT_SWEEP_METRICS_TIMEOUT_S:-20}"
LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S="${LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S:-}"
LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO="${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO:-1}"
LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S="${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S:-1}"
LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS="${LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS:-}"
...
apply_overrides()
{
    ...
    while IFS="$tab" read -r k vb64; do
        ...
        case "$scope:$k" in
            ...
            llama:LLAMA_SERVER_SWEEP_SCRAPE_METRICS) LLAMA_SERVER_SWEEP_SCRAPE_METRICS="$v" ;;
            llama:LLAMA_SERVER_SWEEP_METRICS_TIMEOUT_S) LLAMA_SERVER_SWEEP_METRICS_TIMEOUT_S="$v" ;;
            llama:LLAMA_SERVER_SWEEP_SERVER_ARGS) LLAMA_SERVER_SWEEP_SERVER_ARGS="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP) LLAMA_SERVER_THROUGHPUT_SWEEP="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET) LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_PORT) LLAMA_SERVER_THROUGHPUT_SWEEP_PORT="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_CTX) LLAMA_SERVER_THROUGHPUT_SWEEP_CTX="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS) LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT) LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS) LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT) LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY) LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES) LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES) LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES) LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S) LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S) LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER) LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_SCRAPE_METRICS) LLAMA_SERVER_THROUGHPUT_SWEEP_SCRAPE_METRICS="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_METRICS_TIMEOUT_S) LLAMA_SERVER_THROUGHPUT_SWEEP_METRICS_TIMEOUT_S="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S) LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO) LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S) LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S="$v" ;;
            llama:LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS) LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS="$v" ;;
            llama:LLAMA_FATTN_PATCH_PROBE) LLAMA_FATTN_PATCH_PROBE="$v" ;;
            llama:LLAMA_MULTISLOT_PATCH_PROBE) LLAMA_MULTISLOT_PATCH_PROBE="$v" ;;
...
LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS_B64="$(b64_enc "$LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS")"
...
REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_OUT_DIR="/tmp/baseline_llamacpp_server_throughput_sweep_${ts}"
REMOTE_LLAMA_FATTN_PATCH_PROBE_OUT_DIR="/tmp/baseline_llamacpp_fattn_patch_probe_${ts}"
REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_OUT_DIR="/tmp/baseline_llamacpp_multislot_patch_probe_${ts}"
...
REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_CMD="cat > /tmp/benchmark_llamacpp_multislot_patch_probe.py && chmod +x /tmp/benchmark_llamacpp_multislot_patch_probe.py && LLAMA_DIR='' LLAMA_DIR_B64='${LLAMA_DIR_B64}' OUT_DIR='${REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_OUT_DIR}' /tmp/benchmark_llamacpp_multislot_patch_probe.py"
REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_CMD_PRINT="cat > /tmp/benchmark_llamacpp_multislot_patch_probe.py && chmod +x /tmp/benchmark_llamacpp_multislot_patch_probe.py && LLAMA_DIR_B64='${LLAMA_DIR_B64}' OUT_DIR='${REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_OUT_DIR}' /tmp/benchmark_llamacpp_multislot_patch_probe.py"

REMOTE_LLAMA_SERVER_SWEEP_CMD="cat > /tmp/benchmark_llamacpp_server_sweep.py && chmod +x /tmp/benchmark_llamacpp_server_sweep.py && MODEL_GGUF='' MODEL_GGUF_B64='${MODEL_GGUF_B64}' LLAMA_SERVER='' LLAMA_SERVER_B64='${LLAMA_SERVER_B64}' SERVER_ARGS='' SERVER_ARGS_B64='${LLAMA_SERVER_SWEEP_SERVER_ARGS_B64}' OUT_DIR='${REMOTE_LLAMA_SERVER_SWEEP_OUT_DIR}' START_SERVER=1 KEEP_SERVER='${LLAMA_SERVER_SWEEP_KEEP_SERVER}' CACHE_PROMPT='${LLAMA_SERVER_SWEEP_CACHE_PROMPT}' WAIT_TIMEOUT_S='${LLAMA_SERVER_SWEEP_WAIT_TIMEOUT_S}' POLL_S='${LLAMA_SERVER_SWEEP_POLL_S}' SCRAPE_METRICS='${LLAMA_SERVER_SWEEP_SCRAPE_METRICS}' METRICS_TIMEOUT_S='${LLAMA_SERVER_SWEEP_METRICS_TIMEOUT_S}' PROMPT_WORDS='${LLAMA_SERVER_SWEEP_PROMPT_WORDS}' N_PREDICT='${LLAMA_SERVER_SWEEP_N_PREDICT}' REPEATS='${LLAMA_SERVER_SWEEP_REPEATS}' PORT='${LLAMA_SERVER_SWEEP_PORT}' CTX='${LLAMA_SERVER_SWEEP_CTX:-$CTX}' N_GPU_LAYERS='${N_GPU_LAYERS}' /tmp/benchmark_llamacpp_server_sweep.py"
...
REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_CMD="cat > /tmp/benchmark_llamacpp_server_throughput_sweep.py && chmod +x /tmp/benchmark_llamacpp_server_throughput_sweep.py && MODEL_GGUF='' MODEL_GGUF_B64='${MODEL_GGUF_B64}' LLAMA_SERVER='' LLAMA_SERVER_B64='${LLAMA_SERVER_B64}' SERVER_ARGS='' SERVER_ARGS_B64='${LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS_B64}' OUT_DIR='${REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_OUT_DIR}' START_SERVER=1 KEEP_SERVER='${LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER}' CACHE_PROMPT='${LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT}' WAIT_TIMEOUT_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S}' POLL_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S}' SCRAPE_METRICS='${LLAMA_SERVER_THROUGHPUT_SWEEP_SCRAPE_METRICS}' METRICS_TIMEOUT_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_METRICS_TIMEOUT_S}' REQUEST_TIMEOUT_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S:-}' PROMPT_WORDS='${LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS}' N_PREDICT='${LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT}' REPEATS='${LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS}' CONCURRENCY='${LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY}' PARALLEL_VALUES='${LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES}' BATCH_VALUES='${LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES}' UBATCH_VALUES='${LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES}' RESTART_PER_COMBO='${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO}' RESTART_SLEEP_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S}' PORT='${LLAMA_SERVER_THROUGHPUT_SWEEP_PORT}' CTX='${LLAMA_SERVER_THROUGHPUT_SWEEP_CTX:-$CTX}' N_GPU_LAYERS='${N_GPU_LAYERS}' /tmp/benchmark_llamacpp_server_throughput_sweep.py"
REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_CMD_PRINT="cat > /tmp/benchmark_llamacpp_server_throughput_sweep.py && chmod +x /tmp/benchmark_llamacpp_server_throughput_sweep.py && MODEL_GGUF_B64='${MODEL_GGUF_B64}' LLAMA_SERVER_B64='${LLAMA_SERVER_B64}' SERVER_ARGS_B64='${LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS_B64}' OUT_DIR='${REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_OUT_DIR}' START_SERVER=1 KEEP_SERVER='${LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER}' CACHE_PROMPT='${LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT}' WAIT_TIMEOUT_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S}' POLL_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S}' SCRAPE_METRICS='${LLAMA_SERVER_THROUGHPUT_SWEEP_SCRAPE_METRICS}' METRICS_TIMEOUT_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_METRICS_TIMEOUT_S}' REQUEST_TIMEOUT_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S:-}' PROMPT_WORDS='${LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS}' N_PREDICT='${LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT}' REPEATS='${LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS}' CONCURRENCY='${LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY}' PARALLEL_VALUES='${LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES}' BATCH_VALUES='${LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES}' UBATCH_VALUES='${LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES}' RESTART_PER_COMBO='${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO}' RESTART_SLEEP_S='${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S}' PORT='${LLAMA_SERVER_THROUGHPUT_SWEEP_PORT}' CTX='${LLAMA_SERVER_THROUGHPUT_SWEEP_CTX:-$CTX}' N_GPU_LAYERS='${N_GPU_LAYERS}' /tmp/benchmark_llamacpp_server_throughput_sweep.py"
...
apply_llama_server_throughput_sweep_preset()
{
    preset="$1"
    if [ "$preset" = "" ]; then
        return 0
    ...
    case "$preset" in
        quick)
            if [ "$LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY" = "" ] || [ "$LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY" = "1 2 4 8" ]; then
                LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY="1 2 4"
            fi
            if [ "$LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES" = "" ]; then
                LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES="512 1024"
            fi
            if [ "$LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES" = "" ]; then
                LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES="128 256"
            fi
            ;;
        highbatch)
            if [ "$LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES" = "" ]; then
            ...
            ;;
        *)
            echo "unknown LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET='$preset' (expected: quick, highbatch)" >&2
            return 2
            ;;
    esac
    return 0
...
if [ "$LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET" != "" ]; then
    apply_llama_server_throughput_sweep_preset "$LLAMA_SERVER_THROUGHPUT_SWEEP_PRESET"
fi
...

{
    ...
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP: ${LLAMA_SERVER_THROUGHPUT_SWEEP:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_PORT: ${LLAMA_SERVER_THROUGHPUT_SWEEP_PORT:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_CTX: ${LLAMA_SERVER_THROUGHPUT_SWEEP_CTX:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS: ${LLAMA_SERVER_THROUGHPUT_SWEEP_PROMPT_WORDS:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT: ${LLAMA_SERVER_THROUGHPUT_SWEEP_N_PREDICT:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS: ${LLAMA_SERVER_THROUGHPUT_SWEEP_REPEATS:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT: ${LLAMA_SERVER_THROUGHPUT_SWEEP_CACHE_PROMPT:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY: ${LLAMA_SERVER_THROUGHPUT_SWEEP_CONCURRENCY:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES: ${LLAMA_SERVER_THROUGHPUT_SWEEP_PARALLEL_VALUES:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES: ${LLAMA_SERVER_THROUGHPUT_SWEEP_BATCH_VALUES:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES: ${LLAMA_SERVER_THROUGHPUT_SWEEP_UBATCH_VALUES:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S: ${LLAMA_SERVER_THROUGHPUT_SWEEP_WAIT_TIMEOUT_S:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S: ${LLAMA_SERVER_THROUGHPUT_SWEEP_POLL_S:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER: ${LLAMA_SERVER_THROUGHPUT_SWEEP_KEEP_SERVER:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS: ${LLAMA_SERVER_THROUGHPUT_SWEEP_SERVER_ARGS:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S: ${LLAMA_SERVER_THROUGHPUT_SWEEP_REQUEST_TIMEOUT_S:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO: ${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_PER_COMBO:-<default>}"
    echo "- LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S: ${LLAMA_SERVER_THROUGHPUT_SWEEP_RESTART_SLEEP_S:-<default>}"
    echo "- LLAMA_FATTN_PATCH_PROBE (source scan): ${LLAMA_FATTN_PATCH_PROBE:-<default>}"
    echo "- LLAMA_MULTISLOT_PATCH_PROBE (source scan): ${LLAMA_MULTISLOT_PATCH_PROBE:-<default>}"
    ...
    echo '```'
    echo
    echo "llama.cpp multislot patch probe (optional; LLAMA_MULTISLOT_PATCH_PROBE=1):"
    echo
    echo '```sh'
    echo "ssh $SSH_OPTS $target \"$REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_CMD_PRINT\" < scripts/benchmark_llamacpp_multislot_patch_probe.py"
    echo '```'
    echo
    echo "llama.cpp fattn patch probe (optional; LLAMA_FATTN_PATCH_PROBE=1):"
    echo
    echo '```sh'
    echo "ssh $SSH_OPTS $target \"$REMOTE_LLAMA_FATTN_PATCH_PROBE_CMD_PRINT\" < scripts/benchmark_llamacpp_fattn_patch_probe.py"
    echo '```'
    echo
    ...
    echo '```'
    echo
    echo "llama-server throughput sweep (optional; LLAMA_SERVER_THROUGHPUT_SWEEP=1):"
    echo
    echo '```sh'
    echo "ssh $SSH_OPTS $target \"$REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_CMD_PRINT\" < scripts/benchmark_llamacpp_server_throughput_sweep.py"
    echo '```'
    echo
    echo "vLLM:"
    echo
...
if [ "$LLAMA_MULTISLOT_PATCH_PROBE" = "1" ]; then
    echo "== running llama.cpp multislot patch probe (read-only) =="
    rc_llama_multislot_patch_probe=0
    ssh $SSH_OPTS "$target" "$REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_CMD" <"$repo_root/scripts/benchmark_llamacpp_multislot_patch_probe.py" \
        >"$OUT_DIR/remote_llamacpp_multislot_patch_probe_stdout.txt" 2>"$OUT_DIR/remote_llamacpp_multislot_patch_probe_stderr.txt" || rc_llama_multislot_patch_probe=$?

    LLAMA_MULTISLOT_PATCH_PROBE_ARTIFACT_DIR="$OUT_DIR/spark_llamacpp_multislot_patch_probe_artifacts"
    fetch_remote_artifacts "$target" "$REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_OUT_DIR" "$LLAMA_MULTISLOT_PATCH_PROBE_ARTIFACT_DIR" "llamacpp_multislot_patch_probe" || true

    {
        echo "## llama.cpp multislot patch probe (Spark)"
        echo
        echo "- ssh_exit_code: $rc_llama_multislot_patch_probe"
        echo "- spark_out_dir: $REMOTE_LLAMA_MULTISLOT_PATCH_PROBE_OUT_DIR"
        echo "- spark_artifacts_local: $LLAMA_MULTISLOT_PATCH_PROBE_ARTIFACT_DIR"
        echo
        echo "Full logs:"
        echo
        echo "- stdout: $OUT_DIR/remote_llamacpp_multislot_patch_probe_stdout.txt"
        echo "- stderr: $OUT_DIR/remote_llamacpp_multislot_patch_probe_stderr.txt"
        echo
        echo "Stdout (head):"
        echo
        echo '```'
        sed -n '1,200p' "$OUT_DIR/remote_llamacpp_multislot_patch_probe_stdout.txt" || true
        echo '```'
        echo
        echo "Stderr (head):"
        echo
        echo '```'
        sed -n '1,200p' "$OUT_DIR/remote_llamacpp_multislot_patch_probe_stderr.txt" || true
        echo '```'
        echo
    } >>"$REPORT_MD"
fi
...
if [ "$LLAMA_SERVER_THROUGHPUT_SWEEP" = "1" ]; then
    echo "== running llama-server throughput sweep on spark (may be gated; expensive) =="
    rc_llama_server_throughput_sweep=0
    ssh $SSH_OPTS "$target" "$REMOTE_LLAMA_SERVER_THROUGHPUT_SWEEP_CMD" <"$repo_root/scripts/benchmark_llamacpp_server_throughput_sweep.py" \
        >"$OUT_DIR/remote_llamacpp_server_throughput_sweep_stdout.txt" 2>"$OUT_DIR/remote_llamacpp_server_throughput_sweep_stderr.txt" || rc_llama_server_throughput_sweep=$?
...

    {
        ...
        echo
        echo '```'
        sed -n '1,200p' "$OUT_DIR/remote_llamacpp_server_throughput_sweep_stdout.txt" || true
        echo '```'
        echo
        echo "Stderr (head):"
        echo
        echo '```'
        sed -n '1,200p' "$OUT_DIR/remote_llamacpp_server_throughput_sweep_stderr.txt" || true
        echo '```'
        echo
    } >>"$REPORT_MD"
fi
