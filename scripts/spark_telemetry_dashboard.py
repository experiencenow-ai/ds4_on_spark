...
<div class="chat-head"><div><div class="chat-title">DSAPI Chat</div><div class="label">manual model test console</div></div><div class="chat-controls"><select id="chat-model"><option value="kimi27_pp13">Kimi 2.7</option><option value="qwen27_bf16_pp13">Qwen27</option><option value="gemma4_26b_a4b_pp13">Gemma4</option></select><label>max <input id="chat-max" type="number" min="1" max="8192" step="1" value="512"></label><label>priority <input id="chat-priority" type="number" min="0" max="100" step="1" value="5"></label><label><input id="chat-stream" type="checkbox" checked>stream</label></div></div>
