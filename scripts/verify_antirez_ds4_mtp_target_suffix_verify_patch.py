...
def validate_patch_text(text: str) -> list[str]:
	...
	required = [
		...
		"getenv(\"DS4_MTP_ROW0_TOP1_HEAD\") != NULL && getenv(\"DS4_MTP_ROW0_FULL_LOGITS\") == NULL && row <= 2",
		"row_logits == NULL &&",
		...
		"metal_graph_verify_decode3_exact_tops",
		...
		"ds4_gpu_tensor_write(t, off * sizeof(float), chunk",
		"trace_generated_token_if_requested",
		"DS4_TOKEN_TRACE_LOG",
		"serial_decode_steps",
		"first_eval=0.000 ms",
